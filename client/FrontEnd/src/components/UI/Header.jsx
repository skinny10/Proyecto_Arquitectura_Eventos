...
const navigation = [{ name: "Platinum", to: "/home", current: true }];
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current
                            ? "bg-blue-500 text-white  hover:bg-gray-50 hover:text-black"
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div>
                  <p className="text-white text-base">
                    {" "}
                    Bienvenido {isAuthenticated && user && user.username}{" "}
                  </p>
                </div>
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img className="h-8 w-8 rounded-full" src={cro} alt="" />
                    </Menu.Button>
                  </div>
